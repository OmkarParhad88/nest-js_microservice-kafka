...
const ticketscalarwhereinputSchema = z
  .object({
    AND: z
      .union([
  ...
  .strict();
export const TicketScalarWhereInputObjectSchema: z.ZodType<Prisma.TicketScalarWhereInput> =
  ticketscalarwhereinputSchema as unknown as z.ZodType<Prisma.TicketScalarWhereInput>;
