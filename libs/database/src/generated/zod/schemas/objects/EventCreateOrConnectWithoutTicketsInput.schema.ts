...
const makeSchema = () =>
  z
    ...
    .strict();
export const EventCreateOrConnectWithoutTicketsInputObjectSchema: z.ZodType<Prisma.EventCreateOrConnectWithoutTicketsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EventCreateOrConnectWithoutTicketsInput>;
