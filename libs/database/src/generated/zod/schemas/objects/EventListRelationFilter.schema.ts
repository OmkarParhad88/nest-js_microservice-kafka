...
const makeSchema = () =>
  z
    ...
    .strict();
export const EventListRelationFilterObjectSchema: z.ZodType<Prisma.EventListRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.EventListRelationFilter>;
