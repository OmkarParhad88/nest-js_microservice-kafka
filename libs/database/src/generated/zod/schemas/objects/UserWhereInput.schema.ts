...
const userwhereinputSchema = z
  .object({
    ...
    email: z
      .union([z.lazy(() => StringFilterObjectSchema), z.email().max(191)])
      .optional(),
    name: z
      .union([z.lazy(() => StringFilterObjectSchema), z.string().max(191)])
      .optional(),
    password: z
      .union([z.lazy(() => StringFilterObjectSchema), z.string().max(255)])
      .optional(),
    role: z
