...
const makeSchema = () =>
  z
    .object({
      ...
      upsert: z
        .union([
          ...
          z.lazy(() => TicketUpsertWithWhereUniqueWithoutEventInputObjectSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          ...
          z.lazy(() => TicketUpdateWithWhereUniqueWithoutEventInputObjectSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TicketUpdateManyWithWhereWithoutEventInputObjectSchema),
          z.lazy(() => TicketUpdateManyWithWhereWithoutEventInputObjectSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
    ...
    .strict();
export const TicketUpdateManyWithoutEventNestedInputObjectSchema: z.ZodType<Prisma.TicketUpdateManyWithoutEventNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.TicketUpdateManyWithoutEventNestedInput>;
export const TicketUpdateManyWithoutEventNestedInputObjectZodSchema = makeSchema();
