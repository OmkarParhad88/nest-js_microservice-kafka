...
const makeSchema = () =>
  z
    ...
    .strict();
export const TicketListRelationFilterObjectSchema: z.ZodType<Prisma.TicketListRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.TicketListRelationFilter>;
