  ...
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(() => TicketUncheckedUpdateManyWithoutEventInputObjectSchema),
      ]),
    })
    .strict();
export const TicketUpdateManyWithWhereWithoutEventInputObjectSchema: z.ZodType<Prisma.TicketUpdateManyWithWhereWithoutEventInput> =
  makeSchema() as unknown as z.ZodType<Prisma.TicketUpdateManyWithWhereWithoutEventInput>;
