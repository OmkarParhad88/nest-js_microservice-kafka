...
const eventscalarwhereinputSchema = z
  .object({
    AND: z
      .union([
    ...
    status: z
      .union([z.lazy(() => EnumEventStatusFilterObjectSchema), EventStatusSchema])
      .optional(),
  ...
  .strict();
export const EventScalarWhereInputObjectSchema: z.ZodType<Prisma.EventScalarWhereInput> =
  eventscalarwhereinputSchema as unknown as z.ZodType<Prisma.EventScalarWhereInput>;
