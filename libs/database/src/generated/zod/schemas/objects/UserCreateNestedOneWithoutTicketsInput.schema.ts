...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserCreateNestedOneWithoutTicketsInputObjectSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutTicketsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateNestedOneWithoutTicketsInput>;
