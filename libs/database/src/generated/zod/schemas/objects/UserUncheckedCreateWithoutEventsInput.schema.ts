...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserUncheckedCreateWithoutEventsInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutEventsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUncheckedCreateWithoutEventsInput>;
