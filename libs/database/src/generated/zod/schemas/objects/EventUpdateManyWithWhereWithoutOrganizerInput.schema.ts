  ...
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(() => EventUncheckedUpdateManyWithoutOrganizerInputObjectSchema),
      ]),
    })
    .strict();
export const EventUpdateManyWithWhereWithoutOrganizerInputObjectSchema: z.ZodType<Prisma.EventUpdateManyWithWhereWithoutOrganizerInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EventUpdateManyWithWhereWithoutOrganizerInput>;
