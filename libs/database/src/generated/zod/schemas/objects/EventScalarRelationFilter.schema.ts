...
const makeSchema = () =>
  z
    ...
    .strict();
export const EventScalarRelationFilterObjectSchema: z.ZodType<Prisma.EventScalarRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.EventScalarRelationFilter>;
