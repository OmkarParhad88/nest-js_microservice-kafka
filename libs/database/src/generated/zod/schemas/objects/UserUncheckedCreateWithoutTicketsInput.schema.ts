...
const makeSchema = () =>
  z
    .object({
      ...
      events: z
        .lazy(() => EventUncheckedCreateNestedManyWithoutOrganizerInputObjectSchema)
        .optional(),
    })
    .strict();
export const UserUncheckedCreateWithoutTicketsInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutTicketsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUncheckedCreateWithoutTicketsInput>;
