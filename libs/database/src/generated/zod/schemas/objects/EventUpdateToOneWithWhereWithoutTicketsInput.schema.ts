...
const makeSchema = () =>
  z
    ...
    .strict();
export const EventUpdateToOneWithWhereWithoutTicketsInputObjectSchema: z.ZodType<Prisma.EventUpdateToOneWithWhereWithoutTicketsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EventUpdateToOneWithWhereWithoutTicketsInput>;
