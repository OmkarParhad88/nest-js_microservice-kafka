...
const makeSchema = () =>
  z
    .object({
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutEventsInputObjectSchema),
    ...
    .strict();
export const UserUpdateOneRequiredWithoutEventsNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutEventsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutEventsNestedInput>;
