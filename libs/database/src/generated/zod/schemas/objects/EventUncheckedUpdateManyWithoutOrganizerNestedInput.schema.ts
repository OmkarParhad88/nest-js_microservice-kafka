...
const makeSchema = () => z.object({
  ...
  upsert: z.union([z.lazy(() => EventUpsertWithWhereUniqueWithoutOrganizerInputObjectSchema), z.lazy(() => EventUpsertWithWhereUniqueWithoutOrganizerInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => EventUpdateWithWhereUniqueWithoutOrganizerInputObjectSchema), z.lazy(() => EventUpdateWithWhereUniqueWithoutOrganizerInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => EventUpdateManyWithWhereWithoutOrganizerInputObjectSchema), z.lazy(() => EventUpdateManyWithWhereWithoutOrganizerInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => EventScalarWhereInputObjectSchema), z.lazy(() => EventScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const EventUncheckedUpdateManyWithoutOrganizerNestedInputObjectSchema: z.ZodType<Prisma.EventUncheckedUpdateManyWithoutOrganizerNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.EventUncheckedUpdateManyWithoutOrganizerNestedInput>;
export const EventUncheckedUpdateManyWithoutOrganizerNestedInputObjectZodSchema = makeSchema();
