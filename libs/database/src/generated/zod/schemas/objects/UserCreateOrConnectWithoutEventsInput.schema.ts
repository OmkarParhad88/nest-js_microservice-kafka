...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserCreateOrConnectWithoutEventsInputObjectSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutEventsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateOrConnectWithoutEventsInput>;
