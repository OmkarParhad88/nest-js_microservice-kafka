...
export const TicketCountSchema: z.ZodType<Prisma.TicketCountArgs> = z
  .object({
    orderBy: z
      .union([
    ...
    select: z.union([z.literal(true), TicketCountAggregateInputObjectSchema]).optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.TicketCountArgs>;

export const TicketCountZodSchema = z
  .object({
    orderBy: z
      .union([
        TicketOrderByWithRelationInputObjectSchema,
