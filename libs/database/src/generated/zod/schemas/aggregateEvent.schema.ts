...
export const EventAggregateSchema: z.ZodType<Prisma.EventAggregateArgs> = z
  .object({
    orderBy: z
      .union([
    ...
    _count: z.union([z.literal(true), EventCountAggregateInputObjectSchema]).optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.EventAggregateArgs>;

export const EventAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        EventOrderByWithRelationInputObjectSchema,
