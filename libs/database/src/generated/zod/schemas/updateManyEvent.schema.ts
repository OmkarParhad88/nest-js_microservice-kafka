...
export const EventUpdateManySchema: z.ZodType<Prisma.EventUpdateManyArgs> = z
  .object({
    data: EventUpdateManyMutationInputObjectSchema,
    where: EventWhereInputObjectSchema.optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.EventUpdateManyArgs>;

export const EventUpdateManyZodSchema = z
  .object({
    data: EventUpdateManyMutationInputObjectSchema,
    where: EventWhereInputObjectSchema.optional(),
  })
