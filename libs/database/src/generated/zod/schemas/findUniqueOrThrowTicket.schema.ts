...
export const TicketFindUniqueOrThrowSchema: z.ZodType<Prisma.TicketFindUniqueOrThrowArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.TicketFindUniqueOrThrowArgs>;

export const TicketFindUniqueOrThrowZodSchema = z
  .object({
    select: TicketSelectObjectSchema.optional(),
    include: TicketIncludeObjectSchema.optional(),
    where: TicketWhereUniqueInputObjectSchema,
