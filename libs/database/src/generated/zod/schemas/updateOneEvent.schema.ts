...
export const EventUpdateOneSchema: z.ZodType<Prisma.EventUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EventUpdateArgs>;

export const EventUpdateOneZodSchema = z
  .object({
    select: EventSelectObjectSchema.optional(),
    include: EventIncludeObjectSchema.optional(),
    data: z.union([EventUpdateInputObjectSchema, EventUncheckedUpdateInputObjectSchema]),
