...
export const TicketUpdateManySchema: z.ZodType<Prisma.TicketUpdateManyArgs> = z
  .object({
    data: TicketUpdateManyMutationInputObjectSchema,
    where: TicketWhereInputObjectSchema.optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.TicketUpdateManyArgs>;

export const TicketUpdateManyZodSchema = z
  .object({
    data: TicketUpdateManyMutationInputObjectSchema,
    where: TicketWhereInputObjectSchema.optional(),
  })
