...
export const EventGroupBySchema: z.ZodType<Prisma.EventGroupByArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EventGroupByArgs>;

export const EventGroupByZodSchema = z
  .object({
    where: EventWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
