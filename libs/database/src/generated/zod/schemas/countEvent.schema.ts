...
export const EventCountSchema: z.ZodType<Prisma.EventCountArgs> = z
  .object({
    orderBy: z
      .union([
    ...
    select: z.union([z.literal(true), EventCountAggregateInputObjectSchema]).optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.EventCountArgs>;

export const EventCountZodSchema = z
  .object({
    orderBy: z
      .union([
        EventOrderByWithRelationInputObjectSchema,
