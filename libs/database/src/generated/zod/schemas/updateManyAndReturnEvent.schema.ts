...
export const EventUpdateManyAndReturnSchema: z.ZodType<Prisma.EventUpdateManyAndReturnArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EventUpdateManyAndReturnArgs>;

export const EventUpdateManyAndReturnZodSchema = z
  .object({
    select: EventSelectObjectSchema.optional(),
    data: EventUpdateManyMutationInputObjectSchema,
    where: EventWhereInputObjectSchema.optional(),
