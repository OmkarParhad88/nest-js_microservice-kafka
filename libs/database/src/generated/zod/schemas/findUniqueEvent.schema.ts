...
export const EventFindUniqueSchema: z.ZodType<Prisma.EventFindUniqueArgs> = z
  .object({
    select: EventSelectObjectSchema.optional(),
    include: EventIncludeObjectSchema.optional(),
    where: EventWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.EventFindUniqueArgs>;

export const EventFindUniqueZodSchema = z
  .object({
    select: EventSelectObjectSchema.optional(),
    include: EventIncludeObjectSchema.optional(),
    where: EventWhereUniqueInputObjectSchema,
